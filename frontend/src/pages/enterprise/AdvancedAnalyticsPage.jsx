...
import { BarChart3, Globe, Smartphone, Monitor, Clock, TrendingUp, Users, Download, FileText } from 'lucide-react';
    ...
    <DashboardLayout>
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-primary mb-1 flex items-center gap-2">
              <BarChart3 className="text-yellow-600" size={28} />
              Advanced Analytics
            </h1>
            <p className="text-sm text-secondary">Deep insights into your audience</p>
          </div>
          ...
          <select
            ...
            className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent font-semibold text-sm"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-6">
          ...
          <div className="bg-gradient-to-br from-green-500 to-green-600 rounded-xl shadow-md p-4 text-white">
            ...
            <p className="text-2xl font-bold mb-1">{analytics.uniqueVisitors.toLocaleString()}</p>
            <p className="text-xs opacity-90">Unique Visitors</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-md p-4 text-white">
            ...
            <p className="text-2xl font-bold mb-1">{analytics.avgSessionTime}</p>
            <p className="text-xs opacity-90">Avg Session</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-md p-4 text-white">
            ...
            <p className="text-2xl font-bold mb-1">{analytics.bounceRate}</p>
            <p className="text-xs opacity-90">Bounce Rate</p>
          </div>
        </div>
